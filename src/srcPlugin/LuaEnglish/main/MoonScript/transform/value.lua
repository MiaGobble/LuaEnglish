local Transformer
Transformer = require(script.Parent.transformer).Transformer
local build, ntype, smart_node
do
  local _obj_0 = require(script.Parent.Parent.types)
...
do
  local _obj_0 = require(script.Parent.accumulator)
  Accumulator, default_accumulator = _obj_0.Accumulator, _obj_0.default_accumulator
end
local lua_keywords
lua_keywords = require(script.Parent.Parent.data).lua_keywords
local Run, transform_last_stm, implicitly_return, chain_is_stub
do
  local _obj_0 = require(script.Parent.statements)
...
construct_comprehension = require(script.Parent.comprehension).construct_comprehension
local insert
insert = table.insert
local unpack
