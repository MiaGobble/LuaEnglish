...
do
  local _obj_0 = require(script.Parent.transform.names)
  NameProxy, LocalName = _obj_0.NameProxy, _obj_0.LocalName
end
local Set
Set = require(script.Parent.data).Set
local ntype, value_can_be_statement
do
  local _obj_0 = require(script.Parent.types)
  ntype, value_can_be_statement = _obj_0.ntype, _obj_0.value_can_be_statement
end
local statement_compilers = require(script.Parent.compile.statement)
local value_compilers = require(script.Parent.compile.value)
local concat, insert
do
  local _obj_0 = table
