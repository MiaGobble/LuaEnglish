...
local Stack
Stack = require(script.Parent.data).Stack
local trim, pos_to_line, get_line
do
  local _obj_0 = require(script.Parent.util)
  trim, pos_to_line, get_line = _obj_0.trim, _obj_0.pos_to_line, _obj_0.get_line
end
local unpack
unpack = require(script.Parent.util).unpack
local wrap_env
wrap_env = require(script.Parent.parse.env).wrap_env
...
do
  local _obj_0 = require(script.Parent.parse.literals)
...
do
  local _obj_0 = require(script.Parent.parse.util)
